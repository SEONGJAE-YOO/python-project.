...
# 네이버 검색창에 "구글" 검색해보기 (xpath으로 검색해보기)
...
#검색창에 글자 입력하기  
elem.send_keys("구글")  
elem =  browser.find_element_by_xpath("//*[@id='search_btn']")  #find_element_by_xpath는 xpath를 지정해 요소를 여러개 추출할때 사용한다.
elem.click() #네이버 검색창 오른쪽 돋보기 아이콘의 xpath를 복사후 붙여넣기 한다.
